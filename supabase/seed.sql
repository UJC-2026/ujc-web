...
values
  ('11111111-1111-1111-1111-111111111111', 'Rina Hartono', '210001', 'SI-21A',
  ...
  ('22222222-2222-2222-2222-222222222222', 'Dimas Prakoso', '210002', 'SI-21A',
  ...
  ('33333333-3333-3333-3333-333333333333', 'Siti Nurhaliza', '220015', 'MN-22B',
   'Hamamatsu', 'Shizuoka', 'Manajemen', '2022', 'member', true,
   'Anggota baru, masih belajar bahasa Jepang.', 'Ganbarimasu!', now()),
  ('44444444-4444-4444-4444-444444444444', 'Bagus Setiawan', '210044', 'SI-21B',
...
from (values
  ('11111111-1111-1111-1111-111111111111'::uuid, 'ketua'::divisi),
  ('22222222-2222-2222-2222-222222222222'::uuid, 'pendidikan'::divisi),
  ('44444444-4444-4444-4444-444444444444'::uuid, 'acara'::divisi)
) as v(user_id, divisi)
...
from (values
  ('70000000-0000-0000-0000-000000000001'::uuid, 'tanya-jawab-visa',
  ...
  ('70000000-0000-0000-0000-000000000002'::uuid, 'akademik',
  ...
  ('70000000-0000-0000-0000-000000000003'::uuid, 'kehidupan-di-jepang',
  ...
  ('70000000-0000-0000-0000-000000000004'::uuid, 'lowongan-kerja',
  ...
  ('70000000-0000-0000-0000-000000000005'::uuid, 'akademik',
   '33333333-3333-3333-3333-333333333333'::uuid,
...
values
  ('33333333-3333-3333-3333-333333333333', '70000000-0000-0000-0000-000000000001', 'up'),
  ('44444444-4444-4444-4444-444444444444', '70000000-0000-0000-0000-000000000001', 'up'),
  ('11111111-1111-1111-1111-111111111111', '70000000-0000-0000-0000-000000000001', 'up'),
  ('11111111-1111-1111-1111-111111111111', '70000000-0000-0000-0000-000000000003', 'up'),
  ('33333333-3333-3333-3333-333333333333', '70000000-0000-0000-0000-000000000004', 'up')
on conflict do nothing;

insert into forum_votes (user_id, reply_id, vote)
values
  ('33333333-3333-3333-3333-333333333333', '80000000-0000-0000-0000-000000000002', 'up'),
  ('11111111-1111-1111-1111-111111111111', '80000000-0000-0000-0000-000000000002', 'up'),
  ('44444444-4444-4444-4444-444444444444', '80000000-0000-0000-0000-000000000004', 'up')
on conflict do nothing;
...
values
  ('e0000000-0000-0000-0000-000000000001',
   ...
   false, null, 40, '44444444-4444-4444-4444-444444444444'),
  ...
  ('e0000000-0000-0000-0000-000000000003',
   ...
   false, null, 2, '11111111-1111-1111-1111-111111111111'),
...
values
  ('e0000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'hadir'),
  ('e0000000-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222', 'hadir'),
  ('e0000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', 'mungkin'),
  ('e0000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', 'hadir'),
  ('e0000000-0000-0000-0000-000000000002', '44444444-4444-4444-4444-444444444444', 'hadir'),
  ('e0000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'tidak'),
  ('e0000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'hadir'),
  ('e0000000-0000-0000-0000-000000000003', '22222222-2222-2222-2222-222222222222', 'hadir'),
  ('e0000000-0000-0000-0000-000000000004', '22222222-2222-2222-2222-222222222222', 'hadir')
...
values
  ('Panduan Perpanjangan Visa Student', 'Visa',
   ...
   'https://www.isa.go.jp/en/', null, '22222222-2222-2222-2222-222222222222'),
  ...
  ('Kalender Akademik UNSIA', 'Akademik',
   ...
   'https://unsia.ac.id', null, '11111111-1111-1111-1111-111111111111'),
  ...
  ('Cara Daftar Asuransi Kesehatan (Kokumin Kenko Hoken)', 'Kehidupan',
   ...
   'https://www.mhlw.go.jp/', null, '11111111-1111-1111-1111-111111111111')
on conflict do nothing;
...
values
  ('a1000000-0000-0000-0000-000000000001', 'acara',
   ...
   '44444444-4444-4444-4444-444444444444', 120000, 'berjalan'),
  ('a1000000-0000-0000-0000-000000000002', 'pendidikan',
   'Bank soal JLPT N4 & N3', 'Menyusun 500 soal latihan beserta pembahasan.',
   '500 soal terbit', current_date - 90, current_date + 20,
   '22222222-2222-2222-2222-222222222222', 50000, 'berjalan'),
  ('a1000000-0000-0000-0000-000000000003', 'media',
   'Kalender konten media sosial', 'Posting rutin 3x seminggu di Instagram.',
   'Engagement naik 30%', current_date - 30, current_date + 90,
   '11111111-1111-1111-1111-111111111111', 30000, 'rencana'),
  ('a1000000-0000-0000-0000-000000000004', 'acara',
   'Webinar karier bidang kaigo', 'Menghadirkan alumni yang bekerja di kaigo.',
   '100 peserta', current_date - 120, current_date - 30,
   '44444444-4444-4444-4444-444444444444', 25000, 'selesai'),
  ('a1000000-0000-0000-0000-000000000005', 'bendahara',
   'Digitalisasi laporan kas', 'Pindah pencatatan kas ke sistem website.',
   'Laporan bulanan otomatis', current_date - 45, current_date - 5,
   '11111111-1111-1111-1111-111111111111', null, 'tertunda')
on conflict (id) do nothing;

insert into tasks (program_id, title, description, assigned_to, created_by, due_date, priority, status)
values
  ('a1000000-0000-0000-0000-000000000001', 'Booking tempat kopdar Kanto',
   'Konfirmasi kapasitas dan biaya sewa.',
   '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111',
   current_date + 2, 'tinggi', 'dikerjakan'),
  ('a1000000-0000-0000-0000-000000000001', 'Desain poster kopdar',
   'Ukuran feed dan story Instagram.',
   '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444',
   current_date - 1, 'tinggi', 'todo'),
  ('a1000000-0000-0000-0000-000000000002', 'Review 100 soal N4',
   'Cek kunci jawaban dan pembahasan.',
   '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111',
   current_date + 6, 'sedang', 'dikerjakan'),
  ('a1000000-0000-0000-0000-000000000003', 'Susun draf kalender konten',
   null, '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
   current_date + 30, 'rendah', 'todo'),
  ('a1000000-0000-0000-0000-000000000004', 'Kirim e-sertifikat peserta webinar',
   null, '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111',
...
values
  ...
  ('pemasukan', 'Donasi', 50000, 'Donasi alumni untuk UJC Peduli',
   '11111111-1111-1111-1111-111111111111', current_date - 22),
  ('pengeluaran', 'Kegiatan', 32000, 'Sewa tempat kopdar Chubu',
   '11111111-1111-1111-1111-111111111111', current_date - 18),
  ('pengeluaran', 'Operasional', 12000, 'Langganan alat desain',
   '11111111-1111-1111-1111-111111111111', current_date - 9),
...
values
  ('Rapat koordinasi kopdar Kanto',
   ...
   current_date - 12, '11111111-1111-1111-1111-111111111111'),
  ('Evaluasi webinar kaigo',
   ...
   current_date - 32, '11111111-1111-1111-1111-111111111111')
on conflict do nothing;
...
values
  ('Reels dokumentasi kopdar Kanto', 'Instagram',
   now() + interval '6 days', 'rencana', '11111111-1111-1111-1111-111111111111'),
  ('Poster pendaftaran webinar JLPT', 'Instagram',
   now() + interval '2 days', 'proses', '11111111-1111-1111-1111-111111111111'),
  ('Rekap kegiatan bulan lalu', 'YouTube',
   now() - interval '5 days', 'terbit', '11111111-1111-1111-1111-111111111111')
on conflict do nothing;
...
values
  ('Pendaftaran kopdar Kanto dibuka',
   ...
   '["inapp","email"]'::jsonb, '11111111-1111-1111-1111-111111111111',
   now() - interval '3 days'),
  ('Pengingat pengisian KRS',
   'Batas pengisian KRS semester ini tinggal seminggu lagi. Cek e-link masing-masing.',
   '["inapp"]'::jsonb, '11111111-1111-1111-1111-111111111111', null)
on conflict do nothing;
...
values
  ...
  ('d1000000-0000-0000-0000-000000000001', '44444444-4444-4444-4444-444444444444',
   25000, false, null),
  ('d1000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
   70000, false, 'Turut berduka cita.'),
  ('d1000000-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222',
   50000, true, null)
on conflict do nothing;
...
values
  ('f1000000-0000-0000-0000-000000000002', '44444444-4444-4444-4444-444444444444', 3000),
  ('f1000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 3500)
on conflict do nothing;
...
values
  ('c3000000-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222',
...
from (values
  ('e5000000-0000-0000-0000-000000000001', null, 'Ketua Umum',
   'Memimpin dan mewakili UJC, serta menyetujui pengajuan lintas divisi.', 1),
  ('e5000000-0000-0000-0000-000000000002', 'e5000000-0000-0000-0000-000000000001', 'Wakil Ketua',
   'Mendampingi ketua dan mengambil alih saat ketua berhalangan.', 2),
  ('e5000000-0000-0000-0000-000000000003', 'e5000000-0000-0000-0000-000000000001', 'Sekretaris',
   'Notulen rapat, arsip dokumen, dan surat resmi organisasi.', 3),
  ('e5000000-0000-0000-0000-000000000004', 'e5000000-0000-0000-0000-000000000001', 'Bendahara',
   'Kas komunitas, anggaran kegiatan, dan transparansi donasi UJC Peduli.', 4),
  ('e5000000-0000-0000-0000-000000000005', 'e5000000-0000-0000-0000-000000000001', 'Divisi Pendidikan',
   'Bank soal CBT, materi belajar, dan program mentorship.', 5),
  ('e5000000-0000-0000-0000-000000000006', 'e5000000-0000-0000-0000-000000000001', 'Divisi Kegiatan',
   'Kopdar, workshop, webinar, dan absensi peserta.', 6),
  ('e5000000-0000-0000-0000-000000000007', 'e5000000-0000-0000-0000-000000000001', 'Divisi Media & Publikasi',
   'Kalender konten, pengumuman, galeri, dan blog komunitas.', 7),
  ('e5000000-0000-0000-0000-000000000008', 'e5000000-0000-0000-0000-000000000006', 'Seksi Dokumentasi',
...
values
  ...
  ('e5000000-0000-0000-0000-000000000005', '22222222-2222-2222-2222-222222222222',
   'Dimas Prakoso', 'Tanya dulu, malu kemudian.', 'Osaka', '{}'::jsonb, 'aktif', 1),
  ('e5000000-0000-0000-0000-000000000006', '44444444-4444-4444-4444-444444444444',
   'Bagus Setiawan', 'Kumpul dulu, urusan belakangan.', 'Tokyo', '{}'::jsonb, 'aktif', 1),
  ('e5000000-0000-0000-0000-000000000008', null,
...
values
  ('11111111-1111-1111-1111-111111111111', 'Aichi', 'Nagoya', true),
  ('33333333-3333-3333-3333-333333333333', 'Shizuoka', 'Hamamatsu', true),
  ('44444444-4444-4444-4444-444444444444', 'Tokyo', 'Shinjuku', true),
...
values
  ('33333333-3333-3333-3333-333333333333', 40, 'forum'),
  ('33333333-3333-3333-3333-333333333333', 25, 'cbt'),
  ('11111111-1111-1111-1111-111111111111', 120, 'forum')
on conflict do nothing;
