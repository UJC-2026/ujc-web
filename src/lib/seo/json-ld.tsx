...
export function JsonLd({ data }: { data: Record<string, unknown> }) {
  return (
    <script
      ...
      // `JSON.stringify` escapes quotes but not `<`, so an event title
      // containing a closing script tag would end this tag early and turn
      // everything after it into live markup. Replacing every `<` with its
      // JSON unicode escape parses back to the same string, inertly.
